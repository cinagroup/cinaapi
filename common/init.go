...
func printHelp() {
	fmt.Println("CinaToken(Based OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: CinaGroup - https://github.com/cinagroup/cinatoken")
	fmt.Println("Usage: cinatoken [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
