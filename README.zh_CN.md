...
### 📖 [官方文档](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/cinagroup/cinatoken)
...
- 📱 Telegram 授权登录
- 🔑 OIDC 统一认证
- 🔍 Key 查询使用额度（配合 [new-api-key-tool](https://github.com/cinagroup/cinatoken-key-tool)）
...
| 项目 | 说明 |
|------|------|
| [new-api-key-tool](https://github.com/cinagroup/cinatoken-key-tool) | Key 额度查询工具 |
| [new-api-horizon](https://github.com/cinagroup/cinatoken-horizon) | New API 高性能优化版 |
...
**[官方文档](https://docs.newapi.pro/zh/docs)** • **[问题反馈](https://github.com/cinagroup/cinatoken/issues)** • **[最新发布](https://github.com/cinagroup/cinatoken/releases)**
