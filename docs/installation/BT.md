...
> 📖 官方文档：[宝塔面板部署](https://docs.cinatoken.com/zh/docs/installation/deployment-methods/bt-docker-installation)
...
- [官方文档](https://docs.cinatoken.com/zh/docs/installation)
- [环境变量配置](https://docs.cinatoken.com/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://docs.cinatoken.com/zh/docs/support/faq)
