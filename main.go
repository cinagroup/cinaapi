...
func main() {
	...
	common.SysLog("CinaToken " + common.Version + " started")
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/cinagroup/cinatoken", err),
				"type":    "new_api_panic",
			},
		})
	}))
...
func InjectUmamiAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Umami CinaGroup-->\n")
...
func InjectGoogleAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Google Analytics CinaGroup-->\n")
	analyticsInject := []byte(analyticsInjectBuilder.String())
