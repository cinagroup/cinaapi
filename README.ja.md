...
### 📖 [公式ドキュメント](https://docs.newapi.pro/ja/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/cinagroup/cinatoken)
...
- 📱 Telegram認証ログイン
- 🔑 OIDC統一認証
- 🔍 Key使用量クォータ照会（[new-api-key-tool](https://github.com/cinagroup/cinatoken-key-tool)と併用）
...
| プロジェクト | 説明 |
|------|------|
| [new-api-key-tool](https://github.com/cinagroup/cinatoken-key-tool) | キー使用量クォータ照会ツール |
| [new-api-horizon](https://github.com/cinagroup/cinatoken-horizon) | New API高性能最適化版 |
...
**[公式ドキュメント](https://docs.newapi.pro/ja/docs)** • **[問題フィードバック](https://github.com/cinagroup/cinatoken/issues)** • **[最新リリース](https://github.com/cinagroup/cinatoken/releases)**
