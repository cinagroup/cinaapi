...
📖 その他のデプロイ方法については[デプロイガイド](https://docs.cinatoken.com/ja/docs/installation)を参照してください。
...
### 📖 [公式ドキュメント](https://docs.cinatoken.com/ja/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/cinagroup/cinatoken)
...
| カテゴリ | リンク |
|------|------|
| 🚀 デプロイガイド | [インストールドキュメント](https://docs.cinatoken.com/ja/docs/installation) |
| ⚙️ 環境設定 | [環境変数](https://docs.cinatoken.com/ja/docs/installation/config-maintenance/environment-variables) |
| 📡 APIドキュメント | [APIドキュメント](https://docs.cinatoken.com/ja/docs/api) |
| ❓ よくある質問 | [FAQ](https://docs.cinatoken.com/ja/docs/support/faq) |
| 💬 コミュニティ交流 | [交流チャネル](https://docs.cinatoken.com/ja/docs/support/community-interaction) |

---

## ✨ 主な機能

> 詳細な機能については[機能説明](https://docs.cinatoken.com/ja/docs/guide/wiki/basic-concepts/features-introduction)を参照してください。
...
- 📱 Telegram認証ログイン
- 🔑 OIDC統一認証
- 🔍 Key使用量クォータ照会（[cinatoken-key-tool](https://github.com/cinagroup/cinatoken-key-tool)と併用）
...
**APIフォーマットサポート:**
- ⚡ [OpenAI Responses](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.cinatoken.com/ja/docs/api/ai-model/realtime/create-realtime-session)（Azureを含む）
- ⚡ [Claude Messages](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.cinatoken.com/ja/api/google-gemini-chat)
- 🔄 [Rerankモデル](https://docs.cinatoken.com/ja/docs/api/ai-model/rerank/create-rerank)（Cohere、Jina）
...
> 詳細については[APIドキュメント - ゲートウェイインターフェース](https://docs.cinatoken.com/ja/docs/api)

| モデルタイプ | 説明 | ドキュメント |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI互換モデル | [ドキュメント](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responsesフォーマット | [ドキュメント](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [ドキュメント](https://doc.cinatoken.com/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [ドキュメント](https://doc.cinatoken.com/api/suno-music) |
| 🔄 Rerank | Cohere、Jina | [ドキュメント](https://docs.cinatoken.com/ja/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Messagesフォーマット | [ドキュメント](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Geminiフォーマット | [ドキュメント](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlowモード | - |
...
- [チャットインターフェース (Chat Completions)](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/openai/createchatcompletion)
- [レスポンスインターフェース (Responses)](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/openai/createresponse)
- [イメージインターフェース (Image)](https://docs.cinatoken.com/ja/docs/api/ai-model/images/openai/post-v1-images-generations)
- [オーディオインターフェース (Audio)](https://docs.cinatoken.com/ja/docs/api/ai-model/audio/openai/create-transcription)
- [ビデオインターフェース (Video)](https://docs.cinatoken.com/ja/docs/api/ai-model/audio/openai/createspeech)
- [エンベッドインターフェース (Embeddings)](https://docs.cinatoken.com/ja/docs/api/ai-model/embeddings/createembedding)
- [再ランク付けインターフェース (Rerank)](https://docs.cinatoken.com/ja/docs/api/ai-model/rerank/creatererank)
- [リアルタイム対話インターフェース (Realtime)](https://docs.cinatoken.com/ja/docs/api/ai-model/realtime/createrealtimesession)
- [Claudeチャット](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/createmessage)
- [Google Geminiチャット](https://docs.cinatoken.com/ja/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
📖 **完全な設定:** [環境変数ドキュメント](https://docs.cinatoken.com/ja/docs/installation/config-maintenance/environment-variables)
...
| プロジェクト | 説明 |
|------|------|
| [cinatoken-key-tool](https://github.com/cinagroup/cinatoken-key-tool) | キー使用量クォータ照会ツール |
...
| 📘 よくある質問 | [FAQ](https://docs.cinatoken.com/ja/docs/support/faq) |
| 💬 コミュニティ交流 | [交流チャネル](https://docs.cinatoken.com/ja/docs/support/community-interaction) |
| 🐛 問題のフィードバック | [問題フィードバック](https://docs.cinatoken.com/ja/docs/support/feedback-issues) |
| 📚 完全なドキュメント | [公式ドキュメント](https://docs.cinatoken.com/ja/docs) |
...
**[公式ドキュメント](https://docs.cinatoken.com/ja/docs)** • **[問題フィードバック](https://github.com/cinagroup/cinatoken/issues)** • **[最新リリース](https://github.com/cinagroup/cinatoken/releases)**
